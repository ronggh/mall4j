...
public class YamiSysUserDetailsServiceImpl implements YamiUserDetailsService {
    ...
    private YamiSysUser getUserDetails(String username) {
        ...
        // 构造security用户
        return new YamiSysUser(sysUser.getUserId(), sysUser.getShopId(), sysUser.getUsername(), sysUser.getPassword(),
            sysUser.getStatus() == 1, true, true, true, authorities);
    }
    ...
    private Set<String> getUserPermissions(Long userId) {
        ...
        System.out.println("userId:" + userId + " ===============> " + permsList);
